...
(function() {
    ...
    // Config
    const INPUT_SELECTOR = '#scanInput'; // Adjust to match your webpage
    const SUBMIT_SELECTOR = '#submitBtn'; // Adjust to match your webpage
    ...
    function submitToWebpage(data) {
        return new Promise((resolve, reject) => {
            ...
            if (!input || !submitBtn) {
                reject('Input or submit button not found');
                return;
            }
